    ...
    if (geometry !== void 0) {
      if (precise && geometry.attributes != void 0 && geometry.attributes.position !== void 0) {
        ...
        for (let i = 0, l = position.count; i < l; i++) {
          _vector2.fromBufferAttribute(position, i).applyMatrix4(object.matrixWorld);
...
function WebGLTextures(_gl, extensions, state, properties, capabilities, utils, info) {
  ...
  function uploadTexture(textureProperties, texture, slot) {
    ...
    if (source.version !== source.__currentVersion || forceUpload === true) {
      ...
      const supportsMips = isPowerOfTwo2(image) || isWebGL2, glFormat = utils.convert(texture.format, texture.encoding);
  ...
  function uploadCubeTexture(textureProperties, texture, slot) {
    ...
    if (source.version !== source.__currentVersion || forceUpload === true) {
      ...
      const image = cubeImage[0], supportsMips = isPowerOfTwo2(image) || isWebGL2, glFormat = utils.convert(texture.format, texture.encoding), glType = utils.convert(texture.type), glInternalFormat = getInternalFormat(texture.internalFormat, glFormat, glType, texture.encoding);
      const useTexStorage = isWebGL2 && texture.isVideoTexture !== true;
...
//# sourceMappingURL=three_src_renderers_WebGLRenderer.js.map
